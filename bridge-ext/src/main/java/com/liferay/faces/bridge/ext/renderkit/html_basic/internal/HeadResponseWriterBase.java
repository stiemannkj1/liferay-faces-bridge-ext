...
public abstract class HeadResponseWriterBase extends ResponseWriterWrapper {
	...
	public void endElement(String name) throws IOException {
		...
		if ("head".equals(name)) {
			...
			if (isDirectDescendantOfHead(currentNode)) {
				...
				writeNodeToHeadSection(currentNode, nodeName, componentResource);
				currentNode = null;
			}
			else {
	...
	protected abstract void writeNodeToHeadSection(Node node, String nodeName, UIComponent componentResource)
		throws IOException;
